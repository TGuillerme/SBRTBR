...
The SPR method is commonly described as breaking a tree into to two subtrees and reinserting one of these subtrees -- the source subtree %TG: I've standardised "tree" to "subtree" in the context of source/target subtrees.
...
To avoid these redundant rearrangements, we thus only need to commit one of these moves at most once.
