...
% %MB For now, it's mainly a digression from the main point: only unique 1-move rearrangements from a starting tree
...
The SPR method is commonly described as breaking a tree into to two subtrees and reinserting \textit{one} of these subtrees -- the source subtree %TG: I've standardised "tree" to "subtree" in the context of source/target subtrees.
...
% What defines the target and source subtrees? 
